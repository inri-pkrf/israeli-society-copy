    ...
    <div className="homepage-container">
      <div className="home-inner">
        ...
        <h2 className="home-title">
          ברוכים וברוכות הבאים והבאות<br />לשיעור דיגיטלי על החברה הישראלית
        </h2>

        <p className="info1">
          בסיום השיעור הדיגיטלי תכירו את רבדי החברה הישראלית,
          ...
          בכדי לשפר את התקשורת ולקדם היענות מיטבית בשעת חירום.<br /><br />
